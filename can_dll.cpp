...
extern "C" {
    ...
    public:
        ...
        */
        ...
        /**
            * Метод подключения к UDP-серверу.
        ...
        */
        ...
        /**
            * Метод создания, отправки и получения SDO пакетов для записи.
        ...
        */
        ...
        /**
            * Метод создания, отправки и получения SDO пакетов для чтения.
            * @param receiverId ID узла назначения.
            * @param index Индекс SDO объекта.
            * @param subIndex Сабиндекс SDO объекта.
        ...
        */
        ...
        /**
            * Метод завершения сеанса связи, остановка потока чтения и закрытия сокета.
    ...
    private:
        ...
        */
        ...
        /**
            * Метод прослушивания сокета и распределения пакетов SDO/PDO.
        */
        void PacketListener() {
            while (isConnected) {
                uint16_t can_id;
        ...
        /**
            * Метод записи данных пакета во внешний буфер pdobuffer (передается cobid, длинна значимых байт и сам payload)
            * @return 1 - успешно -1 - не подключены.
        */
        int GetPDO() {
        ...
        /**
            * Метод распределения ответов SDO на массивы ответов SDO записи/чтения.
        ...
        */
        ...
        /**
            * Метод создания заголовка SDO пакета.
        ...
        */
        ...
        /**
            * Метод верификации ответа на наш запрос SDO.
